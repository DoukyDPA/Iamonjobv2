/* AdminPartnersPage.css - Version complète */
.admin-partners-page {
  padding: 2rem;
  max-width: 1400px;
  margin: 0 auto;
...
/* Connexions par offre */
.offers-connections h4 {
  margin: 0 0 1rem 0;
  color: #1e293b;
  font-size: 1.1rem;
}

.offer-connection-item {
  background: #f8fafc;
  padding: 1rem;
  border-radius: 8px;
  margin-bottom: 1rem;
...
/* Styles pour l'affichage des métiers dans les pavés */
.offers-summary {
  background: white;
  padding: 1rem;
  border-radius: 8px;
