...
export const SERVICES_CONFIG = {
  ...
  matching_cv_offre: {
    ...
    icon: '🎯',
    description: 'Découvrez précisément votre adéquation avec cette offre grâce à une analyse IA approfondie avec graphiques détaillés.',
  ...
  analyze_cv: {
    ...
    icon: '📄',
    description: "Obtenez une évaluation professionnelle de votre CV avec des recommandations concrètes pour l'optimiser.",
  ...
  cv_ats_optimization: {
    ...
    icon: '🤖',
    description: "Adaptez votre CV pour qu'il soit parfaitement lisible par les systèmes de tri automatiques des entreprises.",
  ...
  cover_letter_generate: {
    ...
    icon: '✉️',
    description: "Générez une lettre de motivation personnalisée basée sur votre CV et l'offre d'emploi.",
  ...
  interview_prep: {
    ...
    icon: '🎯',
    description: "Préparez-vous efficacement pour vos entretiens d'embauche avec des réponses personnalisées.",
  ...
  follow_up_email: {
    ...
    icon: '📧',
    description: 'Rédigez un email de relance professionnel et structuré pour faire avancer votre candidature.',
  ...
  skills_analysis: {
    ...
    icon: '🔍',
    description: 'Évaluez vos compétences et identifiez vos points forts pour mieux vous positionner.',
  ...
  reconversion_analysis: {
    ...
    icon: '🔄',
    description: 'Explorez une reconversion professionnelle avec une analyse détaillée des étapes et opportunités.',
  ...
  career_transition: {
    ...
    icon: '🚀',
    description: 'Découvrez les métiers compatibles avec votre profil et vos envies.',
  ...
  salary_negotiation: {
    ...
    icon: '💰',
    description: 'Apprenez les techniques pour négocier votre salaire efficacement avec des arguments personnalisés.',
  ...
  industry_orientation: {
    ...
    icon: '🏭',
    description: 'Analyse personnalisée des métiers industriels accessibles.',
  ...
  vv_video: {
    ...
    shortTitle: 'CV Vidéo',
    icon: '🎥',
    description: 'Créez un CV vidéo percutant pour vous démarquer et montrer votre personnalité.',
