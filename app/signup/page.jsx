...
export default function SignupPage() {
  ...
  // Inscription via Google : signInWithPopup crée le compte automatiquement
  // s'il n'existe pas, puis pose le cookie de session comme l'inscription email.
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white border border-cream-200 rounded-2xl shadow-card p-8">
            ...
            <div className="my-5 flex items-center gap-3">
              ...
              <span className="text-xs text-teal-700/50 uppercase font-medium">ou</span>
              <div className="flex-1 h-px bg-cream-200" />
            </div>
            ...
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 px-6 py-3 bg-white border border-cream-300 text-teal-800 rounded-xl font-semibold hover:bg-cream-50 hover:border-teal-300 transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500"
            >
